...
This software processes satellite data from the **ISRO Megha-Tropiques mission**.
...
Satellite datasets are distributed through
**MOSDAC (Meteorological and Oceanographic Satellite Data Archival Centre)** operated by ISRO.
